...
export default function AbilityList() {
  ...
  useEffect(() => {
    const loadAbility = async () => {
      ...
      const response = await FetchData(`ability?offset=${offset}&limit=20`);
      console.log(response);
      setAbilityList(response.results);
    };
    loadAbility();
  }, [pageParam]);
  ...
  return (
    <div className="max-w-6xl mx-auto p-8">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-slate-900 mb-4">Abilities</h2>
        <button
